...
class LoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.pwd_input = page.get_by_test_id('login-form-password-input').locator('input')
    ...
    def fill_login_form(self, login:str, password:str):
        self.email_input.fill(value=login)
        expect(self.email_input).to_have_text(login)

        self.pwd_input.fill(password)
        expect(self.pwd_input).to_have_text(password)
